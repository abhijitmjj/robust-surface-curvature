...
Surface = namedtuple("Surface", ["vertices", "faces", "normal_vec", "res_id"])
"""
...
def read_msms(file_root):
    ...
    """
    Returns namedtuple("Surface", ["vertices", "faces", "normal_vec", "res_id"])
    """
    ...
    return Surface(vertices, faces, normalv, res_id)
